...
const Navbar: React.FC = () => {
    ...
    return (
        <nav className="bg-green-50 dark:bg-gray-800 bg-opacity-50 dark:bg-opacity-90 shadow-md py-4 px-8 flex items-center justify-between">
            <div className="text-xl font-bold text-green-900 dark:text-green-100 tracking-wide">CVE Dashboard</div>
            <div className="flex items-center space-x-6">
                ...
                <button
                    ...
                    className="p-2 rounded-lg bg-green-100 dark:bg-gray-700 text-green-900 dark:text-green-100 hover:bg-green-200 dark:hover:bg-gray-600 transition"
